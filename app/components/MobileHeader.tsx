...
const MobileHeader = () => {
  ...
  return (
    <div className="bg-[#0d1421] w-full h-[97px]">
      <div className="flex justify-between items-center h-[60px] px-[16px] border-b-[#252527] border-b-[1px]">
        <div>
          <Link href={"/"}>
            <svg
              width="168"
        ...
        <div className="flex justify-between items-center w-[128px] py-[15px] ">
          <div
            className={
              darkTheme
                ? "ml-[12px] text-[#A0A0A0] text-[18px] flex items-center justify-center w-[24px] h-[24px]"
                : "ml-[12px] text-black text-[18px] flex items-center justify-center w-[24px] h-[24px]"
            }
          >
            <BsSearch />
          </div>
          ...
          <div
            className={
              darkTheme
                ? "w-[24px] h-[24px] text-[#A0A0A0] text-[24px] flex items-center justify-center "
                : "w-[24px] h-[24px] text-black text-[24px] flex items-center justify-center"
            }
          >
            <FiMenu />
          </div>
      ...
      <div className="border-b-[#252527] border-b-[1px] h-[35.25px] relative">
        <div className="absolute w-[50px] h-full pointer-events-none right-0 top-0 z-[1] bg-gradient-to-r from-[#1b1c2000] to-[#1b1c20]"></div>
        <GlobalStats />
      </div>
    </div>
  );
